    ...
    <Dialog open={open} onClose={handleClose} maxWidth='md' fullWidth>
        ...
        {!result && !error && !isLoading && (
          <Box>
            <Typography variant='body1' sx={{ mb: 2 }}>
              This will update Homebrew itself and then upgrade all installed
              packages. This process may take several minutes.
            </Typography>
            <Alert severity='info' sx={{ mb: 2 }}>
              The update will fetch the latest package information, and the
              upgrade will update all outdated packages to their latest
              versions.
            </Alert>
          </Box>
        )}
      ...
      <DialogActions>
        {!isLoading && !result && !error && (
          <Button
            onClick={handleUpdateAndUpgrade}
            variant='contained'
            color='primary'
          >
